...
if (Test-Path $TabulaHome) {
    ...
    # Always remove runtime-owned layout; keep user data/config/secrets unless -All is set.
    foreach ($item in @("bin", "distrib", "skills", "templates", "testing", "service", "state", "run", ".venv", "logs", "boot-cicd.py")) {
