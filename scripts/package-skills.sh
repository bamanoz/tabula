...
tar -czf "extra/tabula-skills-${VERSION}.tar.gz" \
  --exclude='skills/_pylib/__pycache__' \
  --exclude='skills/_pylib/.pytest_cache' \
  --exclude='skills/_pylib/.pytest_cache/**' \
  --exclude='skills/_pylib/*.pyc' \
  --exclude='skills/_pylib/*/__pycache__' \
  --exclude='skills/_tslib/node_modules' \
  --exclude='skills/_tslib/node_modules/**' \
  --exclude='skills/_tslib/.bun' \
  --exclude='skills/_tslib/.bun/**' \
  --exclude='skills/.venv' \
