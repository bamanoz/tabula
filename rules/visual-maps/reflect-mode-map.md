...
graph TD
    ...
    VerifyImplement -->|"Yes"| VerifySecurity{"Level 4 SECURITY<br>complete or skipped?"}
    VerifySecurity -->|"No"| ReturnSecurity["Return to<br>SECURITY Mode"]
    VerifySecurity -->|"Yes / Not Level 4"| AssessLevel{"Determine<br>Complexity Level"}
