...
def load_provider_session(session_name: str, tools: list[dict], model_override: str = ""):
    from skills.lib.prompt_builder import build_main_system_prompt
    from skills.lib.provider_selection import provider_skill_dir, resolve_provider
    from skills.lib.providers import AnthropicSession, OpenAIChatCompletionsSession
...
def run_task_rounds(task: dict, conn, provider_name: str, provider, max_rounds: int) -> tuple[str, dict]:
    ...
    from skills.lib.providers import ToolResult
