...
- [ ] Three skill directories physically deleted.
- [ ] No reference to deleted skill names in any plugin.toml,
      SKILL.md, or distro manifest in any of the three repos.
- [ ] Distro tests pass after migration.
- [ ] Tabula-distrib testbed coverage of fs/exec replaces
      previous coverage of files/shell.
- [ ] All cross-repo grep guards pass.
- [ ] Documentation updated.
- [ ] No `Hub.ProjectRoot` or `TABULA_PROJECT_ROOT` strings
